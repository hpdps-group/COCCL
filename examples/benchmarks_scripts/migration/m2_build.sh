...
source_root=${1:?usage: m2_build.sh SOURCE_ROOT}
...
test_build=${M2_TESTS_DIR:-$source_root/tests/coccl-tests/build}
host_test_build=${M2_HOST_TEST_DIR:-/data/home/scyb672/run/codex-tmp/coccl-m2-host}
