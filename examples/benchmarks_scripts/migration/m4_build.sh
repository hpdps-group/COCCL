...
source_root=${1:?usage: m4_build.sh SOURCE_ROOT}
...
test_build=${M4_TESTS_DIR:-$source_root/tests/coccl-tests/build}
host_test_build=${M4_HOST_TEST_DIR:-/data/home/scyb672/run/codex-tmp/coccl-m4-host}
...
for target in m1-host-tests m1-plugin-load-test m2-host-tests \
              m3-host-tests m4-host-tests; do
