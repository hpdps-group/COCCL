...
DEFINE_NCCL_PARAM(ncclParamDebugSubsys, uint64_t, NCCL_DEBUG_SUBSYS,
                  NCCL_INIT | NCCL_BOOTSTRAP | NCCL_ENV | COCCL_INIT,
                  NCCL_PARAM_FLAG_PUBLISHED | NCCL_PARAM_FLAG_NO_ENVPLUGIN_INIT,
                  (ncclParamBitsetOf<ncclDebugLogSubSys, uint64_t>(makeOptions(
                    ...
                    makeOption("COCCL", COCCL_ALL, "All COCCL categories"),
                    makeOption("COCCL_INIT", COCCL_INIT, "COCCL initialization and configuration"),
                    makeOption("COCCL_RUNTIME", COCCL_RUNTIME, "COCCL routing and runtime"),
                    makeOption("COCCL_PIPELINE", COCCL_PIPELINE, "COCCL pipeline planning and execution"),
                    makeOption("COCCL_COMPRESS", COCCL_COMPRESS, "COCCL compressor execution"),
                    makeOption("COCCL_MEMORY", COCCL_MEMORY, "COCCL workspace management"),
                    makeOption("COCCL_TUNING", COCCL_TUNING, "COCCL autotune and training classification"),
