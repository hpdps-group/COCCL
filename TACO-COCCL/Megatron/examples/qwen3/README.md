...
A3B \
/mnt/afs/lm/Pai-Megatron-Patch/mnt/qwen-ckpts/Qwen3-30B-A3B \
/mnt/afs/lm/Pai-Megatron-Patch/mnt/qwen-ckpts/Qwen3-30B-A3B-to-mcore  \
false \
true \
bf16
```
...
```bash
cd /mnt/afs/lm/Pai-Megatron-Patch/Pai-Megatron-Patch/examples/qwen3
