...
```bash
cd /mnt/afs/lm/Pai-Megatron-Patch/toolkits/distributed_checkpoints_convertor
bash scripts/qwen2_5/run_8xH20.sh \
7B \
/mnt/afs/lm/Pai-Megatron-Patch/mnt/qwen-ckpts/Qwen2.5-7B \
/mnt/afs/lm/Pai-Megatron-Patch/mnt/qwen-ckpts/Qwen2.5-7B-to-mcore  \
false \
true \
bf16
```
...
/mnt/afs/lm/data/open_web_math/open-web-math_text_document   \
/mnt/afs/lm/Pai-Megatron-Patch/mnt/qwen-ckpts/Qwen2.5-7B-Instruct-to-mcore  \
3072000   \
30000   \
/mnt/afs/lm/Pai-Megatron-Patch/logs/qwen2.5_7B_tp2pp2dp2      2>&1 | tee  /mnt/afs/lm/Pai-Megatron-Patch/logs/qwen2.5_7B_tp2pp2dp2/qwen2.5-7B-3000.log
```
'''
sh run_mcore_qwen.sh  \
dsw  \
...
131072000    \
1310720   \
/mnt/afs/lm/Pai-Megatron-Patch/logs/qwen2.5_7B_tp2pp2dp2    2>&1 | tee  /mnt/afs/lm/lm/coccl-training/logs/qwen2.5-7B-test1.log
'''
#### 指令微调示例
